...
<?php
$id = $_GET['id'];
$sql = ("SELECT * FROM characters c LEFT JOIN cimages img ON c.C_id = img.C_id WHERE user_id=$id");
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-12 col-md-12">
            <a href="usercharview.php?id='.$C_id.'">
            ...
            <a href="delete.php?id='.$C_id.'">Delete Characer</a>
          </div>
        </div>
      </div>
  </div>';
